...
export const recentSales = [
  { order_id: 'CW-7704-A', customer: 'Marikina Footworks', material: 'Full Grain Cow Nappa', qty: '38.0 sqft', total: 10830, date: 'Jun 16, 2026', status: 'Completed', fulfillment: 'Delivery' },
  { order_id: 'CW-7703-B', customer: 'Liceo Shoe Supply', material: 'Italian Nappa', qty: '22.4 sqft', total: 44352, date: 'Jun 16, 2026', status: 'Completed', fulfillment: 'Pickup' },
  { order_id: 'CW-7702-A', customer: 'Rubberworld Trading', material: 'Mixed Scrap Leather', qty: `60.0 ${unitForType('Scrap Leather')}`, total: 5100, date: 'Jun 15, 2026', status: 'Pending', fulfillment: 'Delivery' },
  { order_id: 'CW-7701-C', customer: 'Sta. Lucia Cobblers', material: 'Tan Pebble Grain', qty: '44.0 sqft', total: 13860, date: 'Jun 15, 2026', status: 'Completed', fulfillment: 'Pickup' },
  { order_id: 'CW-7700-A', customer: 'Marikina Footworks', material: 'Cognac Veg-Tan', qty: '29.5 sqft', total: 10620, date: 'Jun 14, 2026', status: 'Pending', fulfillment: 'Delivery' },
  { order_id: 'CW-7699-B', customer: 'Davao Boot Co.', material: 'Black Goat Suede', qty: '12.0 sqft', total: 2700, date: 'Jun 13, 2026', status: 'Completed', fulfillment: 'Pickup' },
]
